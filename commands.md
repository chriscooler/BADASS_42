...
```bash
docker build -t host-p2-dagudelo-1     P2/config_files/host_1
docker build -t host-p2-dagudelo-2     P2/config_files/host_2
docker build -t router-p2-dagudelo-1   P2/config_files/router_1_unicast
docker build -t router-p2-dagudelo-2   P2/config_files/router_2_unicast
docker build -t router-p2-dagudelo-1-u   P2/config_files/router_1_unicast
docker build -t router-p2-dagudelo-2-u   P2/config_files/router_2_unicast
docker build -t router-p2-dagudelo-1-m   P2/config_files/router_1_multicast
docker build -t router-p2-dagudelo-2-m   P2/config_files/router_2_multicast
```
